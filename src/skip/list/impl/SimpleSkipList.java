...
public class SimpleSkipList {
	...
	private SimpleNode sentinel; 								// also known as head
	...
	public SimpleSkipList(int levelOfSkipList) {
		...
		this.sentinel = new SimpleNode(0);
	...
	private void placeNode(SimpleNode newNode, int levelOfNewNode, SimpleNode searchPointer, int data) {
		int counter = 0;
